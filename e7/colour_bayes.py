...
def main(infile):
    ...
    X = data.loc[:,['R','G','B']].to_numpy()/255 # array with shape (n, 3). Divide by 255 so components are all 0-1.
    ...
    model_lab = make_pipeline(FunctionTransformer(converter), GaussianNB())
